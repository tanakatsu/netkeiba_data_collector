...
def main():
    ...
    parser.add_argument('--output', '-o', action='store', type=str, default='jockey_leading.csv', help='output filename')
    ...
    page = 1
    while(True):
        html = getPage("http://db.netkeiba.com/?pid=jockey_leading&year=%d&page=%d" % (year, page))
